...
export default async function Home() {
  ...
  return <main>
    ...
    <footer><a className="brand" href="#top">Six Days</a><p>NYC closure context and timing benchmarks</p><span>{navigator.dateRange} · retrieved {navigator.fetchedAt}</span></footer>
  </main>;
}
